...
flotter= Image.open('Gui/Images/isspyaarkokyanaamdu.png')
...
para2_text =tk.Label(root, text="Ezybit is an intuitive software that automates the installation of",font=('Arial',12)).place(x=getwidth(45),y=getheight(45))
para2_text =tk.Label(root, text="programming languages. With a user-friendly interface, it detects",font=('Arial',12)).place(x=getwidth(45),y=getheight(50))
para2_text =tk.Label(root, text="system requirements and swiftly sets up languages like Python, Java, ",font=('Arial',12)).place(x=getwidth(45),y=getheight(55))
para2_text =tk.Label(root, text="C++, and more, streamlining the development process effortlessly.",font=('Arial',12)).place(x=getwidth(45),y=getheight(60))

para3_text =tk.Label(root, text="With a single click, users can initiate the installation process for their",font=('Arial',12)).place(x=getwidth(45),y=getheight(70))
